...
---
# About
Building community around and gathering knowledge about the world’s termites.
...
| Matthew J. Yoder\* | Data Contributor |
...
- **Cite** this website: Hopkins, H. Isoptera Species File. [retrieval date]. <https://isoptera.speciesfile.org>. See also [Terms of use](#terms-of-use).
...
- Core taxonomic data are exported to and available at the [Catalogue of Life](https://www.catalogueoflife.org/data/taxon/8NKF8) and its [associated API](https://api.checklistbank.org/dataset/3LR/taxon/8NKF8).
...
## History
This species file was originated in TaxonWorks in 2016.
